...
export default function WarehouseShopMenu({
  ...
  return (
    <div className="absolute left-0 top-full z-[80] w-[min(720px,96vw)] overflow-hidden border border-[#c4c4c4] bg-white shadow-[0_8px_24px_rgba(0,0,0,0.12)]">
      <div className="h-1 bg-gradient-to-r from-[#a3841c] via-[#f3e3a3] to-[#a3841c]" />
